<x-app-layout>
    <div class="min-h-screen bg-pink-50/40 py-10">
        <div class="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
            <div class="mb-8">
                <h1 class="text-3xl font-extrabold text-slate-900">Pesanan Masuk</h1>
                <p class="mt-2 text-slate-600">Kelola pesanan dari pembeli untuk produk yang kamu jual.</p>
            </div>
                    ...
                    <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                        <div>
                            <div class="mb-2 flex flex-wrap items-center gap-3">
                                <h2 class="text-xl font-extrabold text-slate-900">{{ $pesanan->kode_pesanan }}</h2>
                            ...
                            <p class="text-sm text-slate-600">
                                Pembeli:
                                <span class="font-bold text-slate-900">{{ $pesanan->buyer->name ?? '-' }}</span>
                            </p>
                        ...
                        <div class="text-left md:text-right">
                            ...
                            <a href="{{ route('pesanan.masuk.show', $pesanan) }}"
